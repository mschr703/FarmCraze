...
#* Diese Datei ist für die Schaf Logik zuständig
#* -> zeichnung, verfolgung, abbruch etc

class Sheep(pygame.sprite.Sprite): #! verwaltet die ingame Schafe
    ...
    def update(self, dt, player_rect, freeze_active): #! Aktualisiert den schafzustand
    ...
    def move_towards(self, target_pos): #! Bewegt das Schaf in richtung des spielers
    ...
    def draw(self, surface): #! Zeichnet das Schaf
